Pod::Spec.new do |s|
  ...
  curl -LO https://github.com/helloooideeeeea/RealTimeCutVADLibraryForXCFramework/releases/download/v1.0.4/onnxruntime.xcframework.zip
  unzip -o onnxruntime.xcframework.zip -d RealTimeCutVADLibrary/Frameworks

  curl -LO https://github.com/helloooideeeeea/RealTimeCutVADLibraryForXCFramework/releases/download/v1.0.4/webrtc_audio_processing.xcframework.zip
